...
const PanelRight: React.FC<PanelRightProps> = ({
  ...
  return (
    <aside
      className={`fixed top-0  overflow-y-auto right-0 h-screen shadow-lg z-30 transition-all duration-300 ease-in-out w-1/4 bg-white dark:bg-black text-black dark:text-white 
